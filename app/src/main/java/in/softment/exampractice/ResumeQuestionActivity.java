...
public class ResumeQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (solvedPaperModel == null || solvedPaperModel.questionModels.size() == 0) {
            finish();
        }
            ...
            public void onClick(View v) {
                ...
                if (!questionModels.get(count).getUserAnswer().isEmpty()) {
                    ...
                    if (count >= questionModels.size() - 1) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(ResumeQuestionActivity.this);
                        ...
                        yes.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                alertDialog.dismiss();
                                submitSolvedPaper(questionModels,solvedPaperModel.getCatId(),solvedPaperModel.getSubCatId(), solvedPaperModel.getCatName(), solvedPaperModel.getSubCatName());
                            }
                        });
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Intent intent = new Intent(ResumeQuestionActivity.this, ResultActivity.class);
                            ...
                            Services.showDialog(ResumeQuestionActivity.this,"ERROR",task.getException().toString());
                        }
                    }
                });
